...
```clj
[net.clojars.savya/beckon "0.5.0"]
```

Clojure CLI (`deps.edn`):

```clj
net.clojars.savya/beckon {:mvn/version "0.5.0"}
```
...
beckon has 11 core functions: `signal-atom`, `add-handler!`,
`remove-handler!`, `clear-handlers!`, `raise!`, `reinit!`, `reinit-all!`,
`dispatch-policy`, `set-dispatch-policy!`, `serial-policy`,
`parallel-policy`, and `bounded-policy`.
